...
fileDir = '/Volumes/SWARM_CODAR/nc/'; %Location of files
saveDir = '/Users/jveatch/Documents/MATLAB/SWARM/plots/'; % where to save images

filePrefix = 'RU_SWARM_';

t0 = datenum(2020, 2, 11, 0, 0, 0);
...
for r = 1:length(dTimes)
    fNames{r} = [filePrefix datestr(dTimes(r), 'yyyymmddTHH0000Z')];
    fLocs{r} = [fileDir fNames{r} '.nc'];
end
...
%     shading interp
    ...
    streakarrow(X,Y, u, v, 1.5, 1, 5);  %%last number is vector resolution, bigger is less
    hold on
...
%     set(gcf, 'paperorientation', 'landscape');
    print('-dpng', [dirListing fNames{p} '-divergence.png'], '-r150')
